...
extension MovieOverviewController: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
		let cell = collectionView.dequeueReusableCell(withReuseIdentifier: MovieOverviewCollectionViewCell.reuseIdentifier, for: indexPath) as! MovieOverviewCollectionViewCell
